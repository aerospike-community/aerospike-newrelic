...
/**
 * AgentFactory for Aerospike. 
 * The name of the Aerospike node, node address(host:port) and login credentials.
...
public class AerospikeAgentFactory extends AgentFactory {
     ...
     * @param Map<String, String> properties of Aerospike node.
